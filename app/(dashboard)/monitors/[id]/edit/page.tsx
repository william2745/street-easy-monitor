...
export default function EditMonitorPage() {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <Link href={`/monitors/${id}`} className="text-xs text-zinc-400 hover:text-violet-600 transition-colors mb-2 inline-flex items-center gap-1">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <section className="bg-white rounded-lg border border-zinc-200 p-5">
          ...
          <input
            ...
            className="w-full border border-zinc-200 rounded-lg px-3 py-2.5 text-sm text-zinc-900 bg-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-colors"
          />
        </section>
